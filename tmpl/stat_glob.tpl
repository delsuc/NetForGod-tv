...
<table border="0" cellspacing="1" cellpadding="1">
    ...
    <tr>
        ...
        <td> <img src="http://www.netforgod.tv/awstats-icon/other/hp.png" width="{{stat_film[i]}}" height="10"></td>
    </tr>
    %end
</table>
<HR>
...
<table border="0" cellspacing="1" cellpadding="1">
    ...
    <tr>
        ...
        <td> <img src="http://www.netforgod.tv/awstats-icon/other/hp.png" width="{{(200*stat_lang[i])/TTotal}}" height="10"></td>
    </tr>
    %end
</table>
<HR>
<h2>Statistiques par jour</h2>
    ...
    %for i in sorted(stat_d):
        <td><img align="bottom" src="http://www.netforgod.tv/awstats-icon/other/vp.png" height="{{int(1.0*stat_d[i])}}" width="8" alt='Nombre de visites: {{stat_d[i]}}' title='Nombre de visites: {{stat_d[i]}}' /></td>
    %end
    </tr>
    <tr valign="middle">
    %for i in sorted(stat_d):
...
<h2>Grands telechargeurs</h2>
    ...
    %for i in sorted(stat_ip.keys(), key = lambda s:stat_ip[s], reverse=True):
        ...
        <td><img align="bottom" src="http://www.netforgod.tv/awstats-icon/other/vp.png" height="{{int(1.0*stat_ip[i])}}" width="8" alt='Nombre de visites: {{stat_ip[i]}}' title='Nombre de visites: {{stat_ip[i]}}' /></td>
    %end
    </tr>
</table>
</body>
