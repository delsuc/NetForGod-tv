...
<ul>
<li>de <a href="http://<?php echo $WEBSITE; ?>/FOI_stats/download_stats.html" title="statistiques de téléchargement">
	Téléchargement
...
<ul>
<li><a href="http://<?php echo $WEBSITE; ?>/munin-monitoring/netforgod.tv/<?php echo $WEBSITE; ?>.html">munin</a>
- courbes d'état du serveur en temps réel</li>
<li><a href="http://<?php echo $WEBSITE; ?>/webalizer">Webalizer</a> - statistiques mensuelles simplifiées </li>
<li><a href="http://<?php echo $WEBSITE; ?>/awstats/awstats.pl">awstats</a> - statistiques mensuelles détaillées</li>
